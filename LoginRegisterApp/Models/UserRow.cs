...
{
    // Read model for the admin "Gestion des utilisateurs" grid. Implements
    // INotifyPropertyChanged so that when a switch is toggled and the DB
    // write succeeds, updating these properties refreshes the grid cell
