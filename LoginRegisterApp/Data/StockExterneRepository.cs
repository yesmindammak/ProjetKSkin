    ...
    public static class StockExterneRepository
    {
        ...
        public static void EnsureExternalTablesAndSeedDisponibilites()
        {
            try
            {
                ...
                // 1. Create PointDeVente table in KSkinStockExterne
                ...
                // 2. Create ProduitPointDeVente table in KSkinStockExterne
                ...
                // 3. Seed Points de Vente (EXCLUDING Trocadero Sousse, distinct store locations across Tunisia)
                ...
                // 4. Seed diverse disponibilites for products if ProduitPointDeVente is empty
